...
/**
 * Salesforce DTO for SObject WorkPerformanceCycleFeed
 */
@XStreamAlias("WorkPerformanceCycleFeed")
public class WorkPerformanceCycleFeed extends AbstractSObjectBase {
