...
/**
 * Salesforce DTO for SObject WorkFeedbackTemplateShare
 */
@XStreamAlias("WorkFeedbackTemplateShare")
public class WorkFeedbackTemplateShare extends AbstractSObjectBase {
