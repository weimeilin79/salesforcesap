...
public class Opportunity extends AbstractSObjectBase {
    ...
    // mobileuser__c
    private Double mobileuser__c;

    @JsonProperty("mobileuser__c")
    public Double getmobileuser__c() {
        return this.mobileuser__c;
    }

    @JsonProperty("mobileuser__c")
    public void setmobileuser__c(Double mobileuser__c) {
        this.mobileuser__c = mobileuser__c;
    }
