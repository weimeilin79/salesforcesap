...
/**
 * Salesforce DTO for SObject WorkPerformanceCycleShare
 */
@XStreamAlias("WorkPerformanceCycleShare")
public class WorkPerformanceCycleShare extends AbstractSObjectBase {
