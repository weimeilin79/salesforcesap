...
/**
 * Salesforce DTO for SObject WorkFeedbackRequestShare
 */
@XStreamAlias("WorkFeedbackRequestShare")
public class WorkFeedbackRequestShare extends AbstractSObjectBase {
