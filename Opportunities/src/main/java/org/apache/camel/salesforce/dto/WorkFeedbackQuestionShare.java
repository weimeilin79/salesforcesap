...
/**
 * Salesforce DTO for SObject WorkFeedbackQuestionShare
 */
@XStreamAlias("WorkFeedbackQuestionShare")
public class WorkFeedbackQuestionShare extends AbstractSObjectBase {
