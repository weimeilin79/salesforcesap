...
/**
 * Salesforce DTO for SObject WorkFeedbackRequestFeed
 */
@XStreamAlias("WorkFeedbackRequestFeed")
public class WorkFeedbackRequestFeed extends AbstractSObjectBase {
