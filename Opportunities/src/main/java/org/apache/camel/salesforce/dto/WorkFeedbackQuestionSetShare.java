...
/**
 * Salesforce DTO for SObject WorkFeedbackQuestionSetShare
 */
@XStreamAlias("WorkFeedbackQuestionSetShare")
public class WorkFeedbackQuestionSetShare extends AbstractSObjectBase {
